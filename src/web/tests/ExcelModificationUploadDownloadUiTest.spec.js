...
test('Upload & Download Excel Validation', async ({ page }) => {
    ...
    ExcelFileUtils.writeExcelTest("Sheet1", textSearch, 350, { rowChange: 0, colChange: 2 }, "./src/web/data/ModifyTest.xlsx");
    ...
    // Now we have to validate after uploading the updated excel sheet. The UI table got updated with the new values or not.
